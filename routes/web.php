...
Route::get('/store/{store}/product', [StoresController::class,'showProducts'])->name('store_product.show');
...
Route::patch('/cart/{cart}/{product}', [CartsController::class,'update'])->name('cart.update');
